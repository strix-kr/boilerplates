...
import TestHOC from '@/graphql/queries/TestHOC.gql';

const { Content } = Layout;

function Container(props) {
  const result = service.getValue(props, 'data.trade', {});

  if (service.getValue(props, 'data.loading', false)) {
    return (<Spinner tip="fetching" size="large" />)
  }
  
  return (
    <Layout className="example-hoc-container">
...
export default graphql(TestHOC)(Container);
